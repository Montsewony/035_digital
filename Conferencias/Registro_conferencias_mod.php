    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center text-left">
        <div class="col-lg-10 align-self-end">
          <h1 class="text-uppercase text-white font-weight-bold">Agregar conferencia</h1>
...
echo"<p>Fecha de la conferencia: <input type= date name= fcha value=  $fcha  min=  $fcha  max= 2090-12-31T12:00Z/></p>"
 ?>
        ...
        <p>Hora de término: <input type="time" name="termino" value="00:00:00" max="23:00:00" min="08:00:00" step="1"  /></p>
        ...
        <p>Número de lugares: <input type="number" name="nlugares" required min="0" max="999999"pattern="[0-9]+" /></p>
        <div>
  ...
  <footer class="bg-light py-5">
      ...
      <div class="small text-center text-muted">Escalona Espinosa omam Sebastian & Hernández de la Rosa Itzel Montserrat / Modelos de Prueba de Software / 3CV61</div>
